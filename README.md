...
```sh
git clone https://github.com/michaelamponsah/hello-rails-react.git
```
...
Feel free to check the [issues page](https://github.com/michaelamponsah/hello-rails-react/issues).
